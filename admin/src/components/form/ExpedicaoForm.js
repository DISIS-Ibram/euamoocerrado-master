  ...
  static defaultProps = {
    ...
    novoPlanejamento = (e)=>{
     ...
     this.props.openModal( { nome:"modal_planejamentoexpedicao",
                              ...
                              onSave:()=>{
                                this.props.load('planejamentoexpedicao',{},{expedicao:this.props.itens.id})
                             },
                              value:{expedicao:this.props.itens.id}
                            } 
                            )
   ...
   novoRelatorio = (e)=>{
     ...
     this.props.openModal( {nome:"modal_relatoriodeexpedicao",
                              ...
                              onSave:()=>{
                                this.props.load('relatoriodeexpedicao',{},{expedicao:this.props.itens.id})
                             },
                              value:{expedicao:this.props.itens.id}
                            } 
                            )
  ...
  render(){
      ...
      return (  
          <div className='row'>
            ...
            <ListaSection modelo="planejamentoexpedicao" 
                          titulo="Planejamento"
           ...
           ||
             ...
             <div className='col-xs-6 col-sm-5 col-sm-5 tac'>
                    <center className="fs1 gray" > Salve a Expedição para um planejamento ou relatório </center>
            </div>
