...
// import StatusRegistroSubList from 'statusRegistroSubList';


class StatusRegistroForm extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <form onSubmit={handleSubmit} className={className}>
        ...
        <div>
          <Field autoComplete="off" autoCorrect='off' spellCheck="false" rows="1" className="descricao autoheight" name="descricao" placeholder="Descrição" component="textarea"  type="text"/>
        </div>
...
connect( 
  ...
  si3Actions)(StatusRegistroForm);

export default StatusRegistroForm;