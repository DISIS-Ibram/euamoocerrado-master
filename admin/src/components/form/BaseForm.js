...
export function loaderComponent(Wc){
     ...
     let newClass = class LoaderComp extends Wc{
        ...
        static propTypes = {
            modeloNome: React.PropTypes.oneOfType([
        ...
        componentWillMount() {    
                ...
                if(this.props.id){
                 //se nao tem id para carregar
                  ...
                  if(this.props.id === '' || this.props.id == 'all' || this.props.id == undefined){
                      id=''
                  } else {
                      id = this.props.id;
                  }
                ...
                if( _.isArray(modeloNome) ){   
                  ...
                  modelosToLoad = [{ type:modeloNome,obj:resources,opt:{include:incl} }]
                }else{
    ...
    const makeSelector = (state,props) =>{    
        ...
        return createSelector( 
                      [getModeloApi], 
                      (objectes) =>  {
                          console.count("======== chamando createSelector Func Load Comp ===========")
                          console.log("props")
                          console.log(props)
                ...
                return (
                 ...
                 return (
                  ...
                  <div className="formulario ui">
                      <Wcf ref={(v)=>this.MC = v}  {...this.props} itens={this.props.itens} initialValues={this.props.itens} validate={this._validate.bind(this)} form="Modelo X" /> ;
                 </div>
                 )
                 //return super.render()
              }
