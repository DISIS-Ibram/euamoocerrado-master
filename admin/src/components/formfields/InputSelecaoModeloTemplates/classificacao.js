...
import { Popup, Header, Dropdown, Form, Label, List, Radio, Checkbox, Icon, Accordion, Input, Dimmer, Loader, Image, Segment, Button } from 'semantic-ui-react';
...
export class renderItem extends React.Component{
   ...
   static defaultProps={
    ...
    render(){
        return(
            <div><h3><Icon name="remove" onClick={this.props.removeItem} />{this.props.item.id}-{this.props.item.padrao.nome}</h3></div>
          )
    }
}
