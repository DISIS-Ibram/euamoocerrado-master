...
export default class InputGeoArea extends React.Component {
  ...
  _mounted = (drawControl) => {
    ...
    this.refs.map.leafletElement.fitBounds(
      drawControl.options.edit.featureGroup.getBounds()
    );
    // }
      ...
      features: [
        {
          ...
          geometry: {
            ...
            coordinates: [
              [
                [-51.9873046875, -12.511665400971019],
                [-55.85449218749999, -15.919073517982413],
                [-47.9443359375, -16.34122561920748],
                [-42.275390625, -13.496472765758952],
                [-51.9873046875, -12.511665400971019],
              ],
            ],
          },
    ...
    return (
      <div className="geopointwraper rel" ref="wrappedComponent">
        ...
        >
          <FormField
            {...this.props}
            dica="Desenhe a área, ou ARRASTE aqui os arquivos de geo para selecionar"
          >
