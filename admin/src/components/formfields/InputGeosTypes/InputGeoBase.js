    ...
    render (){
     ...
     return (
        ...
        >
          ...
          <FormField {...this.props}  dica='Digite as coordenadas ou o nome do estado > municipio > localidade'>
            ...
            <div className='geoDropdown row-400px '>
                  ...
                  selIndex:{this.state.selIndex}
                    ...
                    <div className={`${mapmode} mapwrap`}
                          ...
                          center={positioninicialmapa} zoom={this.zoom} className='col-xs-12 row-xs-12'>
                             ...
                             <FeatureGroup >                                
                                ...
                                <DrawControl
                                  ...
                                  draw={{
                                      rectangle: this.props.geom =="area" && true || false,
                                      circle: this.props.geom =="area" && true || false,
                                      polygon:this.props.geom =="area" && true || false,
                                      polyline:false,
...
export class DrawControl extends LayersControl {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (_.isEqual(this.props.draw, prevProps.draw) || this.props.position !== prevProps.position) {
      return false;
    }
