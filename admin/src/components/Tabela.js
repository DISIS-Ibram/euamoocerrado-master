...
import { Loader, Container, Button, Icon, Table, Input, Dropdown, Message } from 'semantic-ui-react';
...
const _debug = true;
const myconsole = criaconsole(_debug,' *** Tabela.js | ', 'color:green;font-weight:bold')
