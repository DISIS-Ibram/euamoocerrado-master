...
export default class MapaAtrativosDefault extends React.Component {
  ...
  render() {
    ...
    _.each(this.props.itens.tipobenfeitoria, (item) => {
      itemsBenfeitorias.push({
        ...item,
        _tipo: "benfeitoria",
        _tipoGeom: "point",
        _identifier: item.id + "tipobenfeitoria",
      });
    });
    ...
    return (
      <div className="row">
        <div className="col-xs-12">
          ...
          <p>
            <small>
              Selecione um atrativo que deseja incluir e depois clique on deseja
              incluir no mapa abaixo
            </small>
          </p>
...
export class MapaAtrativos extends React.Component {
  ...
  render() {
    ...
    let atrativosParque = _.get(this.props, "itens.atrativo_set", []).map(
      (atrativo) => {
        let iconeurl =
          window.SI3CONFIG.url +
          "obtericone/?url=" +
    ...
    return (
      ...
      >
        ...
        >
          {" "}
          Carregar Arquivo com Geometria do Parque{" "}
        </Button>
        <input
          type="file"
          multiple
