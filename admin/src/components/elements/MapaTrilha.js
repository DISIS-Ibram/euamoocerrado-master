...
import { Map, Marker, Tooltip, Popup, TileLayer, LayersControl, FeatureGroup, Circle, CircleMarker, GeoJSON, Polygon, Polyline } from 'react-leaflet';
...
export  default class MapaAtrativosDefault extends React.Component {
  ...
  render(){
      ...
      _.each(this.props.itens, item=>{
        items.push( {...item, _tipo:'atrativotrilha', _tipoGeom:'point' , _identifier:item.id+'tipoatrativo'} )
      })
      ...
      return (
        ...
        <div className="row">
              <div className="col-xs-12">
                ...
                <p >
                  <small>
                       Crie ou importe a trilha abaixo
                    </small>
               ...
               <MapaAtrativos id={this.props.idtrilha} 
                    tipobenfeitoria={[]} 
              ...
              featureGroup.on('click',(e)=>{
                  if(e.layer.options.model === "atrativotrilha"){
                    let atrativoid = e.layer.options.item.id
                         ...
                         this.props.openModal( { nome:"atrativotrilha",
                              tipo:'form',
...
saveParqueGeom = async()=>{
 ...
 processFiles = (filelist)=>{
    ...
    render (){
      ...
      let atrativosTrilha = this.props.itens.atrativotrilha_set.map( atrativo=>{ 
        ...
        <div className={'geoinput dragandrop'} ref={(el) => this.dropI = el} 
            ...
            { this.state.uploaded_GeoJSON &&
              <MapaSelectedFeature geoJSON={this.state.uploaded_GeoJSON}
                  point={false} polyline={true} polygon={true}
                          ...
                          <LayersMapa  />
                            ...
                            <FeatureGroup ref='featured' >                 
                                ...
                                { atrativosTrilha.map( (item,i)=>
                                    ...
                                    <Marker key={'atrativotrilha'+i} position={[item.geom.coordinates[1], item.geom.coordinates[0] ] }
                                      item={item}
                            ...
                            }} > Carregar Arquivo com Geometria da Trilha </Button>
                            <input type="file" ref="fileinput" style={{display:'none'}} onChange={(e)=>this.fileSelected(e).bind(this)}/>
