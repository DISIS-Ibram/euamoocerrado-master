...
export  default class MapaAtrativosDefault extends React.Component {
  ...
  render(){
      ...
      _.each(this.props.itens.tipoatrativo, item=>{
        items.push( {...item, _tipo:'atrativo', _tipoGeom:'point' , _identifier:item.id+'tipoatrativo'} )
      })
      ...
      return (
        ...
        <div className="row" >
              <div className="col-xs-12">
                ...
                <h3> Atrativos e Benfeitorias </h3>
                          ...
                          <LayersMapa  />
                            ...
                            <FeatureGroup ref='featured' >                 
                              ...
                              { this.state.polygonLayers.map( item =>
                                ...
                                { this.props.itens.atrativo_set.map( (item,i)=>
                                    //  <Marker position={[-15,-45]} />
                                    <Marker key={'atrativo'+i} position={[item.geom.coordinates[1], item.geom.coordinates[0] ] }
                                      item={item}
                                      model="atrativo" 
                                      icon={ L.icon({
                                        iconUrl: window.SI3CONFIG.url+"obtericone/?url="+item.tipo_atrativo.icone,
                                        iconSize: [30, 30],
                                        iconAnchor: [15, 15],
                                        popupAnchor: [-3, -76],
                                      })}
