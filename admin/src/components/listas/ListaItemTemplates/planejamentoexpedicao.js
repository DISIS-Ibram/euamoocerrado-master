...
export const titulo = (item) => {
    ...
    return (
        <span>
             { moment(item.previsao_inicio).format('L') } -
             { moment(item.previsao_fim).format('L') }
        </span>)
}
...
export const descricao = (item) => {
    return (
        <div>
          <div>
            <small> <b> Detalhamento Logístico:</b> </small>
            <br />
            <ViewMore>
              <small>  { item.detalhamento_logistico } </small>
            </ViewMore>
          </div>
          <div>
            <small> <b> Orçamento:</b> </small>
            <br />
            <ViewMore>
              <small> { item.orcamento_resumido } </small>
            </ViewMore>
          </div>
        </div>
    )
