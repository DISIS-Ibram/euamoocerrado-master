...
export const titulo = (item) => {   
    ...
    return (
        <span>
          <small> 
             { _.get(item,'nome') } - { moment(item.data).format('L') }
...
export const descricao = (item) => {
    return (
        <div>
            <div>  
                <small> <b> Tipo:</b>  {_.get(item,'tipo_evento.nome')} </small>
            </div>   

             <div>  
                <ViewMore>
                       <small> <b> Descrição:</b> </small>  <small>  {item.descricao} </small>
                </ViewMore>
            </div>   
                ...
                <small>   
                     <span>
             {/* { moment(item.data_inicial).format('L') } - { moment(item.data_final).format('L') } */}
                </span>
            </small>
