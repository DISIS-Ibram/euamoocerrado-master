...
@withRouter
export default class TextosPage extends React.Component
{

   componentDidMount() {
         document.title = "Textos";
    }
   ...
   render()
    {
        ...
        let modelo = this.props.params.item || "";
            modelo = (modelo == 'lista') ? 'conteudo' : modelo;
        ...
        return(
            ...
            <PageInterna nome={nomePagina} icon='trilha' icontipo='svg' menu={this.menu()}>
