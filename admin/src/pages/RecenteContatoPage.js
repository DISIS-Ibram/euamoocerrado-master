...
export default class RecenteContato extends React.Component
{
   ...
   componentDidMount() {
         document.title = "SI3RC :: Recente Contato";
    }
   ...
   render()
    {
        ...
        let modelo = this.props.params.item || "";
            modelo = (modelo == 'lista') ? 'povo' : modelo;
        ...
        var nomePagina = "Recente Contato";
        switch (modelo){
        ...
        return(
            ...
            <PageInterna nome={nomePagina} icon='reccontato' icontipo='svg' menu={this.menu()}>
