...
import {Menu, Container, Grid, Image, Icon as Icone, Button } from 'semantic-ui-react'
      ...
      return(
            <div className='page'>
                            ...
                            <div className="col-xs col-xs-offset-1 ta-l">
                                ...
                                {this.props.goBack &&
                                    <div className="col-xs-1 col-50px ta-r bd-d-1">
                                        <Button circular icon="chevron left" onClick={ this.upOneLevel} />
                                    </div>
                                    }
                                <div className="col-xs">
                                 <h1 className='page-title hidden-xs'>
                                    <Icon size='3rem' tipo={this.props.icontipo || 'fa'} name={this.props.icon}  />  <span>{this.props.nome || ''}</span>
                                  </h1>
                                  </div>
                                  </div>
                            </div>

                            <div className="col-xs ta-l" key={"menu_topo_usuario"+_.get(this.props,'usuario.user.pk')} >
                              {this.props.menu}
                            </div>
                ...
                <div className="conteudo container-fluid col-xs-12 ta-l ">
                         <div className="row">
                           <div className="col-xs-11 col-xs-offset-1"  key={"conteudo_usuario"+_.get(this.props,'usuario.user.pk')}>
                               {this.props.children}
