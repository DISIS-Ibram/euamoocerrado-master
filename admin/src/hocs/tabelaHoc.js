...
const _debug = true;
const myconsole = criaconsole(_debug,' *** tabelaHOC | ', 'color:red;font-weight:bold')
...
export default function connectBaseForm(WrapComp){
    ...
    let newClass = class BaseForm extends WrapComp{
          ...
          static defaultProps = {
            // modelo: "",
            loadFormOptions:false,   //carrego opcoes do formulario, criando as validacoes antes do servidor
         ...
         _validate(values){
          ...
          _prepararInfo(item){
              ...
              if( _.isEmpty(itemPreparado) ){  //o initial values precisa ser sempre um objeto, nesse caso se tiver false ou algum erro, retorno objeto vazio
                  ...
                  if(this.props.value){
                    return {nome:this.props.value}  //LETODO ser o campo de identificacao principal do modelo
                  }else{
                    return {};
                  }
          ...
          _salvar(values){
              ...
              return this.props.save(this.props.modelo, values)
                     .catch((response)=>{
                          if(response.status == 400){ //400 é bad request
          ...
          _depoisDeSalvar(response,dispatch){
              ...
              if(super.depoisDeSalvar){
                    ...
                    let id = response[0][getIDKey(this.props.modelo)];
                    this.props.depoisDeSalvar(response, dispatch, id);
                      ...
                      if(id){
                           ...
                           let path = window.location.pathname
                            ...
                            browserHistory.replace(newPath+"/"+id)
                ...
                myconsole.log("render | initialValues:%o",initialValues)
                 ...
                 return (
                  ...
                  <div className="formulario ui">
                      <WrapCompWithReduxForm ref={(v)=>this.MC = v}  
                          {...this.props} 
                          itens={initialValues} 
     ...
     newClass = carregaModelo(newClass)
