...
const myconsoleCS = criaconsole(
  false,
  " *** createSelector | ",
  "color:red;font-weight:bold"
);
const myconsoleMP = criaconsole(
  false,
  " *** mapStateToProps | ",
...
export default function carregaModelo(Wc) {
  return class extends React.Component {
    nomeClasse = "Nome do decorator para o componente Tabela.js";

    render() {
      return <Wc {...this.props} modelo={this.nomeClasse} />;
    }
  };
}
// ####################### TESTE #####################################
...
//       if (id != 0 && id != "new") {
//         //so 0 ou new, vazio como "" eu nao considero como um id
...
//       } else {
//         myconsole.log(
//           "Nao preciso carregar pois ja tenho itens:",
//           this.props.itens
//         );
//       }
//     }
...
//           if (temFalse === undefined) carregouItens = true;
//         }
//       }
...
//         //se é so um modelo vejo se o itens é falso
//         if (this.modelosToLoad.length == 1 && _.isString(props.modelo)) {
//           if (_.isEmpty(props.formOptions) == false) carregouFormOptions = true;
//           //se tenho vario modelos vejo se todos os subitens de itens nao é falso
//         } else if (this.modelosToLoad.length > 0 && _.isArray(props.modelo)) {
//           if (props.formOptions) {
//             let temFalse = _.find(props.formOptions, (v, k) => _.isEmpty(v));
//             if (temFalse === undefined) carregouFormOptions = true;
//           }
//         }
//       } else {
...
//       if (
//         this.state.loadingStatus == "start" ||
//         (this.state.loadingStatus == "loading" && this.props.loader === true)
//       ) {
//         return (
//           <div className="">
//             {(this.state.erro && (
...
//       } else {
//         let itens =
//           this.state.loadingStatus == "loaded" ? this.props.itens : [];
//         let loading =
//           this.state.loadingStatus == "loaded" ||
//           this.state.loadingStatus == "erro"
//             ? false
//             : true;
...
//       if (props.id != "all") {
//         //se tenho id- tem que ser o ID só para o primeiro modelo
...
//         myconsoleCS.log(
//           "recebido (quer dizer que mudou os objetos). getModeloApi:%o,getIDVal:%o, formOptions:%o",
//           objectes,
//           id,
//           formOptions
//         );
...
//           myconsoleMP.log(
//             "state.api.formOptions.modelo",
//             state.api.formOptions[model]
//           );
