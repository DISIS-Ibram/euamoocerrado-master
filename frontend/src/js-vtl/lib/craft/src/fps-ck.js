/**@
    ...
    * })
    */Crafty.c("FPS",{values:[],maxValues:60,init:function(){this.bind("MessureFPS",function(e){this.values.length>this.maxValues&&this.values.splice(0,1);this.values.push(e.value)})}});