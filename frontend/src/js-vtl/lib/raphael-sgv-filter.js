...
(function() {
     ...
     *            established by attribute â€˜primitiveUnitsâ€™ on the â€˜filterâ€™
     ...
     *            â€˜stdDeviationâ€™ is 0 in only one of X or Y, then the effect is
     ...
     * performed without specifying a complete matrix. If attribute â€˜typeâ€™ is
     * not specified, then the effect is as if a value of matrix were specified.
     *
     * values an array of numbers - The contents of â€˜valuesâ€™ depends on the
     * value of attribute â€˜typeâ€™:
     *
     */
     ...
     *
     * @param params -
     *            an object with the format {funcR: {â€˜typeâ€™, â€˜tableValuesâ€™,
     *            â€˜slopeâ€™, â€˜interceptâ€™, â€˜amplitudeâ€™, â€˜exponentâ€™, â€˜offsetâ€™},
     ...
     *            each dimension for â€˜kernelMatrixâ€™. The values provided must be
     ...
     *
     * @param divisor -
     *            number After applying the â€˜kernelMatrixâ€™ to the input image to
     *            yield a number, that number is divided by â€˜divisorâ€™ to yield
     ...
     *
     * bias - a number After applying the â€˜kernelMatrixâ€™ to the input image to
     * yield a number and applying the â€˜divisorâ€™, the â€˜biasâ€™ attribute is added
     * to each component. One application of â€˜biasâ€™ is when it is desirable to
     ...
     * would otherwise be clamped to 0 or 1. If â€˜biasâ€™ is not specified, then
     ...
     * of attribute â€˜primitiveUnitsâ€™) between successive columns and rows,
     * respectively, in the â€˜kernelMatrixâ€™. By specifying value(s) for
     * â€˜kernelUnitLengthâ€™, the kernel becomes defined in a scalable, abstract
     * coordinate system. If â€˜kernelUnitLengthâ€™ is not specified, the default
     ...
     * value be provided for at least one of â€˜filterResâ€™ and â€˜kernelUnitLengthâ€™.
     ...
     * â€˜preserveAlphaâ€™ is not specified, then the effect is as if a value of
     ...
     * infinite extent and the filter result is the input to an â€˜feTileâ€™, the
     * filter is evaluated with periodic boundary conditions.
     *
     * Because â€˜feMorphologyâ€™ operates on premultipied color values, it will
     ...
     *            â€˜operatorâ€™ is not specified, then the effect is as if a value
     ...
     * initial seed value is computed based on attribute â€˜seedâ€™. Then the
     ...
     * the value of property â€˜color-interpolation-filtersâ€™:
     *
     *
     * @param baseFrequency = "
     ...
     *            â€˜stitchTilesâ€™ is not specified, then the effect is as if a
     ...
     *            attribute â€˜typeâ€™ is not specified, then the effect is as if a
     ...
     * made to the â€˜image-renderingâ€™ property setting to determine the authors
     * intent.
     *
     * @param dx = "
     *            <number>" The amount to offset the input graphic along the
     *            x-axis. The offset amount is expressed in the coordinate
     *            system established by attribute â€˜primitiveUnitsâ€™ on the
     *            â€˜filterâ€™ element. If the attribute is not specified, then the
     *            effect is as if a value of 0 were specified.
     *
     * @param dy = "
     *            <number>" The amount to offset the input graphic along the
     ...
     * â€˜feMergeNodeâ€™ child element) on the bottom and the last specified input,
     * InputN (corresponding to the last â€˜feMergeNodeâ€™ child element), on top.
     *
     ...
     *
     * Each â€˜feMergeâ€™ element can have any number of â€˜feMergeNodeâ€™ subelements,
     * each of which has an â€˜inâ€™ attribute.
     *
     ...
     *
     * If the topmost image input is SourceGraphic and this â€˜feMergeâ€™ is the
     ...
     *            determined by the value of attribute â€˜primitiveUnitsâ€™) for dx
     *            and dy, respectively, in the surface normal calculation
     *            formulas. By specifying value(s) for â€˜kernelUnitLengthâ€™, the
     *            kernel becomes defined in a scalable, abstract coordinate
     *            system. If â€˜kernelUnitLengthâ€™ is not specified, the dx and dy
     ...
     *            at least one of â€˜filterResâ€™ and â€˜kernelUnitLengthâ€™. Discussion
     *            of intermediate images are in the Introduction and in the
     *            description of attribute â€˜filterResâ€™. A negative or zero value
     *            is an error.
     */
    ...
    // * One of the image blending modes (see table below). If attribute â€˜modeâ€™
    ...
    // attribute can take on the same values as the â€˜inâ€™ attribute.
    // *
    // */
